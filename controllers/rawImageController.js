...
var getRawImage = function (message, callback) {
    ...
    switch (deviceType) {
            ...
            openStream(streamingUrl, retryTime, function (cap) {
                ...
                if (vCap != null) {
                    ...
                    vCap.read((err, frame) => {
                        ...
                        frame.save(rawImgFullPath);
                        var outBase64 = imageProcessingController.base64_encode(rawImgFullPath);
        ...
        case 'Mobile':
            console.log("Mobile camera raw image call for --- ", camId);
            var rawImgName = camId + ".jpg";
            var rawImgFullPath = config.rawImageDirectory + "/" + rawImgName;
