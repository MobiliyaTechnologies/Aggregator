        ...
        case startStreamingTopic:
            {
                ...
                if (parsedJson.deviceType !== "Mobile") {
                    boundingBox(sendData, function (camId, detectionType, streamingUrl, bboxes, cameraFolder, jetsonFolderPath) {
                        startLiveStreaming(camId, detectionType, streamingUrl, bboxes, cameraFolder, jetsonFolderPath);
...
*/
var startLiveStreaming = function (camId, detectionType, streamingUrl, bboxes, cameraFolder, jetsonFolderPath) {
    ...
    if (!fs.existsSync(cameraFolder)) {
        mkdirp(cameraFolder, function (err) {
            if (err) {
                ...
                callback(camId, detectionType, streamingUrl, parsedJson.Coords, cameraFolder, jetsonFolderPath);
            }
        });
    } else
        callback(camId, detectionType, streamingUrl, parsedJson.Coords, cameraFolder, jetsonFolderPath);
